...
export default function ClusterStats() {
    ...
    // Simulate data for all 3 nodes with some randomness to show it's "live"
    const baseTime = Date.now();
    const timeVariation = Math.sin(baseTime / 10000) * 0.5; // Slow oscillation

    // Generate data for all 3 nodes
    const allNodes = [
        {
            hostname: 'raspberrypi5',
            platform: "linux",
            arch: "arm64",
            cpuTemp: 32.6 + timeVariation,
            cpuUsage: [
            ...
            memoryUsage: {
                total: 3.7,
                used: Math.round((0.34 + Math.sin(baseTime / 15000) * 0.1) * 100) / 100,
                free: Math.round((3.37 - Math.sin(baseTime / 15000) * 0.1) * 100) / 100
            }
        },
        {
            hostname: 'pi4',
            ...
            memoryUsage: {
                total: 7.87,
                used: Math.round((2.8 + Math.cos(baseTime / 12000) * 0.2) * 100) / 100,
                free: Math.round((5.08 - Math.cos(baseTime / 12000) * 0.2) * 100) / 100
            }
        },
        {
            hostname: 'cluter2',
            ...
            memoryUsage: {
                total: 7.87,
                used: Math.round((1.8 + Math.sin(baseTime / 18000) * 0.15) * 100) / 100,
                free: Math.round((6.07 - Math.sin(baseTime / 18000) * 0.15) * 100) / 100
            }
        }
    ];
